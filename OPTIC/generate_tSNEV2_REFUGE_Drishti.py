...
if __name__ == '__main__':
    ...
    config.Target_Dataset = ['Drishti_GS', 'REFUGE']
    config.Target_Dataset.remove(config.Source_Dataset)


    output_file_path = '/data/chengzhicao/VLM/VPTTA-main/visual_tsne/REFUGE_Drishtiv2'
    ...
    RIM_ONE_r3_data = []
    img_listRIM_ONE_r3_data = os.listdir(path1)
    img_listRIM_ONE_r3_data.sort()
    for i in range(len(img_listRIM_ONE_r3_data)):
        img_path = os.path.join(path1,img_listRIM_ONE_r3_data[i])
    ...
    print('data=',RIM_ONE_r3_data.shape)


    path1 = '/data/chengzhicao/VLM/VPTTA-main/visualization_segmentation_resultsv5_OPTIC_tSNE/Drishti_GS'
    path1 = '/data/chengzhicao/VLM/VPTTA-main/visualization_segmentation_results_GNN_prompt_OPTICv1/OPTIC_lr0.001_memory_size40_neighbor16_optimizerAdam_threshold0.4_iters1_inn_num8_Source_Dataset_REFUGE_Target_Dataset_Drishti_GS'
    RIM_ONE_r3_data = []
    ...
    for k in range(50):
        ...
        label_list = ['Target', 'Source', 'Target', 'Class 4']
        # 遍历所有标签种类
        ...
        _out_path = os.path.join(output_file_path,'visualization_tSNE_{}.png'.format(RANDOM_STATE))
