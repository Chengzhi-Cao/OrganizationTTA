...
class TrainSource:
    def __init__(self, config):
        ...
        train_dataset = OPTIC_dataset(config.dataset_root, sr_img_list, sr_label_list,
                                      config.image_size, img_normalize=False, batch_size=config.batch_size) # dataset_root='/data/chengzhicao/VLM/TTDG/datasets/Fundus'
    ...
    def run(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch, data in enumerate(self.source_train_loader):
                x, y = data['data'], data['mask']   # x=[8,3,512,512], y=[8,2,512,512]
                ...
                pred, fea = self.model(x)   # x=[8,3,512,512], pred=[8,2,512,512]
...
if __name__ == '__main__':
    ...
    # Path
    parser.add_argument('--path_save_log', type=str, default='/data/chengzhicao/VLM/VPTTA-main/train_source_model/logs/')
    parser.add_argument('--path_save_model', type=str, default='/data/chengzhicao/VLM/VPTTA-main/train_source_model/models/')
