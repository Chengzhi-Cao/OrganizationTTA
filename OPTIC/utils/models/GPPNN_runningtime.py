...
# from models.refine import Refine1
# from modules import InvertibleConv1x1
# from models.utils.modules import InvertibleConv1x1
# from refine import Refine1
import torch.nn.init as init
import math
from functools import reduce
# from model_GNN import VGNN
...
# model1 = VGNN(num_patches=64)
# input1 = torch.ones(1,3,128,128)
...
class UNetConvBlock(nn.Module):
    def __init__(self, in_size, out_size, relu_slope=0.1, use_HIN=False):
...
class DenseBlock(nn.Module):
    def __init__(self, channel_in, channel_out, init='xavier', gc=16, bias=True):
        ...
        self.conv1 = UNetConvBlock(channel_in, gc)  # channel_in=2, channel_out=1, gc=16
...
class InvBlock(nn.Module):
    def __init__(self, subnet_constructor, channel_num, channel_split_num, clamp=0.8):
        ...
        self.invconv = nn.Conv2d(in_channels=in_channels,out_channels=in_channels,kernel_size=1)
    ...
    def forward(self, x, rev=False):
        ...
        x1, x2 = (x.narrow(1, 0, self.split_len1), x.narrow(1, self.split_len1, self.split_len2))   # x=[8,3,128,128]
        # x2 = x1
        ...
        return out  # out=[8,4,128,128]


class FeatureExtract(nn.Module):
    def __init__(self, channel_in=3, channel_split_num=2, subnet_constructor=subnet('DBNet'), block_num=2):
...
# # model1 = GPPNN(ms_channels=3,pan_channels=3,n_feat=3,n_layer=3)
# input1 = torch.ones(1,3,128,128)
