...
class Prompt(nn.Module):
    def __init__(self, prompt_alpha=1/32, image_size=512):
        ...
        self.conv1 = nn.Conv2d(3, 3, kernel_size=15,stride=15, bias=False)
    ...
    def forward(self, x):   # x=[1,3,512,512]
        ...
        amp_low_ = F.interpolate(x, scale_factor=self.prompt_alpha, mode='nearest')  # amp_low_=[1,3,16,16]
        
        return x, amp_low_ # src_in_trg=[1,3,512,512]根据低频区域还原的图片, amp_low_=[1,3,5,5]是原图片的低频区域
