...
class Promptv6(nn.Module):
    def __init__(self, prompt_alpha=1/32, image_size=512,inn_num=2,num_ViGBlocks=1,num_edge=9):
        super().__init__()
        ...
        self.VGNN = VGNN(num_patches=1024,out_feature=256*3,num_ViGBlocks=self.num_ViGBlocks,num_edges =self.num_edge )
