...
if __name__ == '__main__':
    ...
    output_file_path = '/data/chengzhicao/VLM/VPTTA-main/visual_tsne/Source_Dataset_REFUGE_Target_Dataset_RIM_ONE_r3v3'
    ...
    for k in range(50):
        ...
        # color_map = {0:'#40E0D0', 1:'#6A5ACD', 2:'#EE82EE', 3:'m'}   # 定义类别颜色映射关系
        ...
        # labels = np.concatenate((label1, label3))
        # print(data.shape, labels.shape)
        ...
        # # # 遍历所有样本
        # # color_map = {0:'r', 1:'g', 2:'b', 3:'m'}   # 定义类别颜色映射关系
        # color_map = {0:'#40E0D0', 1:'#EE82EE', 2:'#EE82EE', 3:'m'}   # 定义类别颜色映射关系
        # # shape_map = {0:'o', 1:'D', 2:'^', 3:'P'}
        # shape_map = {0:'o',1:'o',2:'o' }
        # # label_map = {0:'Class 1', 1:'Class 2', 2:'Class 3', 3:'Class 4'}
        # label_map = {0:'Source', 1:'Target'}
