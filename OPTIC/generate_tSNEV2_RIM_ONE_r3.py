...
if __name__ == '__main__':
    ...
    output_file_path = '/data/chengzhicao/VLM/VPTTA-main/visual_tsne/Source_Dataset_REFUGE_Target_Dataset_RIM_ONE_r3'
    ...
    RIM_ONE_r3_data = []
    img_listRIM_ONE_r3 = os.listdir(path1)
    img_listRIM_ONE_r3.sort()
    for i in range(len(img_listRIM_ONE_r3)):
        img_path = os.path.join(path1,img_listRIM_ONE_r3[i])
    ...
    # path1 = '/data/chengzhicao/VLM/VPTTA-main/visualization_segmentation_results_GNN_prompt_OPTICv1/Source_Dataset_RIM_ONE_r3_Target_Dataset_REFUGE'
    path1 = '/data/chengzhicao/VLM/VPTTA-main/visualization_segmentation_results_GNN_prompt_OPTICv1/Source_Dataset_REFUGE_Target_Dataset_RIM_ONE_r3'
    RIM_ONE_r3_data = []
