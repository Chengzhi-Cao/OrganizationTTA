...
# from utils.prompt_myv6 import Promptv6 as Prompt
from utils.prompt_myv7 import Promptv6 as Prompt
...
class VPTTA:
    ...
    def build_model(self):
        self.prompt = Prompt(prompt_alpha=self.prompt_alpha, image_size=self.image_size,inn_num=self.inn_num,num_ViGBlocks=self.num_ViGBlocks).to(self.device)    # image_size=512
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inn_num', type=int, default=2)
    parser.add_argument('--num_ViGBlocks', type=int, default=1)
    parser.add_argument('--num_edge', type=int, default=9)
    # Optimizer
