...
# from normalize import normalize_image, normalize_image_to_0_1
from dataloaders.normalize import normalize_image, normalize_image_to_0_1
# from OPTIC.dataloaders.normalize import normalize_image, normalize_image_to_0_1
...
class OPTIC_dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        img_path = '{}_x.jpg'.format(self.global_num)
        
        
        
        img = img.resize(self.target_size)
        label = label.resize(self.target_size, resample=Image.NEAREST)
        img.save(os.path.join(self.save_path1,img_path))  
