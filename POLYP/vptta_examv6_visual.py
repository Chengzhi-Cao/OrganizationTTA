...
from utils.promptv6_visual import Prompt
    ...
    def run(self):
        ...
        for batch, data in enumerate(self.target_test_loader):
            ...
            for tr_ites in range(self.iters):
                prompt_x, _ = self.prompt(x)    # prompt_x=[1,3,352,352]
            ...
            self.prompt.eval()
            with torch.no_grad():
                prompt_x, low_freq = self.prompt(x)# prompt_x=[1,3,352,352], low_freq=[1,484,768]
...
if __name__ == '__main__':
    ...
    # A BKAI-IGH-NeoPolyp, 1000
    # B CVC ClinicDB [1], 612
    # C ETIS-LaribPolypDB 196
    # D Kvasir-Seg 1000
