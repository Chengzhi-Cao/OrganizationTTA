...
from utils.promptv6 import Prompt
...
class VPTTA:
    ...
    def build_model(self):
        self.prompt = Prompt(prompt_alpha=self.prompt_alpha, image_size=self.image_size,inn_num=self.inn_num,num_ViGBlocks=self.num_ViGBlocks).to(self.device)
